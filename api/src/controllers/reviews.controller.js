...
export const accept = async (req, res) => res.json(successResponse(req, await reviewsService.acceptAssignment(req.user, req.validated.params.assignmentId, req.requestId)));
