...
innovationsRouter.get('/feedback', authorize('INNOVATOR'), controller.feedback);
...
innovationsRouter.get('/:id/evidence/:evidenceId/download', authorize('INNOVATOR', 'EXPERT', 'SYSTEM_ADMINISTRATOR'), controller.downloadEvidence);
