// Official administrative names sourced from the Rwanda Ministry of Environment
// administrative-boundaries feature service. Keep this reference data separate
// from innovation classifications managed by the System Administrator.
...
export function locationIsValid(province, district, sector) {
  return Boolean(rwandaLocations[province]?.[district]?.includes(sector));
}
